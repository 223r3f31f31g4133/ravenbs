...
public class Utils implements IMinecraftInstance {
    ...
    public static double distanceToSq(Vec3 vec3) {
        double deltaX = mc.thePlayer.posX - vec3.xCoord;
        double deltaY = mc.thePlayer.posY - vec3.yCoord;
        double deltaZ = mc.thePlayer.posZ - vec3.zCoord;
        return deltaX * deltaX + deltaY * deltaY + deltaZ * deltaZ;
    }

    public static boolean holdingBlocks() {
